...
Claire: firstly I want to investigate the total alcohol consumption by countries but I can only use geom_col as I have two columns. Still, it was a fun exploration, see graph "Top 20 Countries in Alcohol Consumption" below.
...
```
Then I set out to explore the geom_histogram. I played with the bins setting several times and found that if I set bins to 25, the graph looks nice as the scale of alcohol consumption is 0-15. However, as y-axis represents "count", I don't actually know how to interpret the graph.
```{r}
